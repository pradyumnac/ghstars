...
class RealGitHubClient:
    ...
    fetch_stars, fetch_lists, and check_rate_limit are implemented here —
    List/membership mutations land in ticket 04, unstar in ticket 06. Those
    methods exist to satisfy the GitHubClient Protocol and raise
